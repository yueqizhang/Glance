...
/**
 * Created by Jonah on 1/28/16.
 */
public class AccountCardAdapter extends ArrayAdapter<Post> {
    // Use LOG_TAG when logging anything
    private final String LOG_TAG = AccountCardAdapter.class.getSimpleName();
    ...
    //Constructor
    public AccountCardAdapter(Context context, int layoutResourceId, ArrayList<Post> posts) {
