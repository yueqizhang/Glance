...
public class InstagramDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_LOCATION_TABLE = "CREATE TABLE " + InstagramContract.UserEntry.TABLE_NAME + " (" +
        ...
        final String SQL_CREATE_WEATHER_TABLE = "CREATE TABLE " + InstagramContract.PostEntry.TABLE_NAME + " (" +
